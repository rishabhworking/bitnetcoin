...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Russian investigative journalist Ivan Golunov hospitalized 2 days after his arrest";
        CTransaction txNew;
        txNew.nTime = 1560068353;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1560068353;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 3280029;

        if (fTestNet)
        {
            block.nTime    = 1560068752;
            block.nNonce   = 385402275;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf2dc32d86e7f6ef71a4af774fc7c26aa536d39274f9d798545fee2ba83cab38b"));
